...
public class MathUtility {
    ...
    //VÌ NHX TÍNH TOÁN NÀY TÍNH XONG RỒI TRẢ RA, KO CẦN LƯU TRỮ LẠI
    //DO ĐÓ TA THIẾT KẾ NÓ BẰNG STATIC

    //TA LÀM HÀM TÍNH N! = 1.2.3.4...N
    //QUY ƯỚC
    //O! = 1 (CỦA BÊN TOÁN HỌC)
    ...
    public static long getFactorial(int n) {
        ...
        //tính n! = 1.2.3.4... thuật toán con heo đất, ốc bu nhồi thịt, nhân dồn,
        // cộng dồn tích lũy
        long result = 1;
        for (int i = 1; i <= n; i++) {
